...
Config.Garages = {
    ...
    ["Garagem Conssecionária"] = {
        ["positions"] = {
            ["menu"] = {
                ["position"] = vector3(-59.89, -1111.89, 26.43)
            },
            ["vehicle"] = {
                ["position"] = vector3(-54.31, -1110.97, 26.44), 
                ["heading"] = 79.05
            }
        },
        ["camera"] = { 
...
Config.Labels = {
    ["menu"] = "~INPUT_CONTEXT~ Abrir garagem %s.",
    ["vehicle"] = "~INPUT_CONTEXT~ Guardar o carro '%s' na tua garagem."
}
